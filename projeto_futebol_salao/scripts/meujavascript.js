...
if(descricao.innerHTML.length > 100){
    ...
    descricao.style.fontSize = "large"
}
...
mensagem='';
itens_acoes.forEach(function(l,i){//forEach está atribuíndo um valor temporário ao l//
...
itens_acoes.forEach(function(it){
    it.ondblclick=function(e){ //e.preventDefault serve deixar de executar a ação padrão//
        e.preventDefault();
